...
// pool.
void tpool_create(size_t thread_count) { NOT_IMPLEMENTED_VOID(); }

// Frees the memory and destructs the threadpool.
void tpool_destroy(tpool_t pool) { NOT_IMPLEMENTED_VOID(); }
...
bool tpool_wait(tpool_t pool) { NOT_IMPLEMENTED(bool); }
